...
public class com_gwtplatform_mvp_client_DesktopGinjector_DesktopGinjectorGinjector_fragment {
   ...
   *   com.arcbees.analytics.client.AnalyticsModule.configure(AnalyticsModule.java:73)
   */
  public java.lang.String get_Key$type$java$lang$String$_annotation$$com$google$inject$name$Named$value$gaAccount$$() {
    java.lang.String result = "UA-46636703-1";
    return result;
  ...
  /**
   * Binding for java.lang.Boolean declared at:
   *   com.arcbees.analytics.client.AnalyticsModule.configure(AnalyticsModule.java:74)
   */
  public java.lang.Boolean get_Key$type$java$lang$Boolean$_annotation$$com$google$inject$name$Named$value$uaAutoCreate$$() {
  ...
  /**
   * Binding for java.lang.String declared at:
   *   com.viaxoft.mines.ProjetPI_EMSE.client.gin.DemoModule.configure(DemoModule.java:43)
   */
  ...
  /**
   * Binding for java.lang.String declared at:
   *   com.viaxoft.mines.ProjetPI_EMSE.client.gin.DemoModule.configure(DemoModule.java:44)
   */
  ...
  /**
   * Binding for java.lang.String declared at:
   *   com.viaxoft.mines.ProjetPI_EMSE.client.gin.DemoModule.configure(DemoModule.java:45)
   */
